...
bool ros2web_interfaces__msg__body_part__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2web_interfaces.msg._body_part.BodyPart", full_classname_dest, 42) == 0);
  }
  ros2web_interfaces__msg__BodyPart * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of BodyPart */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2web_interfaces.msg._body_part");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BodyPart");
